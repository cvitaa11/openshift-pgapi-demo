            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.HasMany(d => d.CustomerTypes)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        l => l.HasOne<CustomerDemographic>().WithMany().HasForeignKey("CustomerTypeId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("customer_customer_demo_customer_type_id_fkey"),
                        r => r.HasOne<Customer>().WithMany().HasForeignKey("CustomerId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("customer_customer_demo_customer_id_fkey"),
                        j =>
                        {
